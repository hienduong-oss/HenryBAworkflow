...
- May read: `paths.project_memory` or hot decisions, `paths.design_doc`, `paths.shared_shell_contract`, `paths.shared_shell_index`, module warm shard, and `paths.srs_index` for targeted screen lookup.
