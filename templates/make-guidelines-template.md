# Hướng dẫn chạy Figma Make theo module (Module Make Guidelines)

## Input bundle

- Shared rules: `plans/{slug}-{date}/05_tool-lanes/figma-make/shared-rules.md`
...
- Keep `DESIGN.md` as the visual baseline
- Keep `screen-field-contract.yaml` as the schema and behavior baseline
- Never recover missing requirements by guessing
- Route drift to `impact`
