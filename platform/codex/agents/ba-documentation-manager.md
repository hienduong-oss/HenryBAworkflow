...
- Audit cross-artifact consistency across FRD, user stories, SRS, screen canon ASCII, and packaged HTML.
- Verify user story traceability across SRS FRs, UCs, and SCRs.
- Check that use case actions, screen actions, field names, validation rules, screen canon ASCII labels, and user-supplied mockup labels use identical terminology.
