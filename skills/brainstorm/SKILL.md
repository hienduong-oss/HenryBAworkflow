...
- **Per-feature path** — `docs/{feature}/brainstorms/{idea-slug}.md`. **1 feature có thể có nhiều brainstorm ideas**. Workflow KHÔNG gộp tự động.
