# Golden: F16 - frd Guardrail Enforces backbone-index First
...
| allow_reads_includes | core/contract.yaml, core/contract-behavior.md, plans/test-project-20260424/02_backbone/backbone-index.md, plans/test-project-20260424/01_intake/plan.md |
| deny_reads_includes | plans/test-project-20260424/02_backbone/backbone.md |
| excerpt_plan | backbone_by_module |
| message | GUARDRAIL: cmd=frd mode=index-first idx=backbone_index current=1 allow=contract.yaml,backbone-index.md,plan.md deny=backbone |
...
| violations.count | 0 |
| warnings.count | 0 |
| message | GUARDRAIL_AUDIT_PASS: cmd=frd |
...
- The guardrail contract is discovery-scoped here. Generated excerpt paths are adapter-specific and stay out of the parity golden.
